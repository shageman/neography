...
Bulk operations use Typhoeus::Hydra for parallelizing requests:
  ...
  relationships = @neo.create_relationships(
      [[:contact, nodes[0], nodes[1], {'since' => '2011-04-21'}]
       [:friend, nodes[1], nodes[2]]])                           # Create two relationships with and without properties
